...
private:
    ...
    // added part
    ros::Subscriber navdata__gps_sub;
    ...
    //added part
    ardrone_autonomy::navdata_gps lastnavdata_gpsReceived;
...
public:
    ...
    //added part
    void navdata_gpsCb(const ardrone_autonomy::navdata_gpsConstPtr navdata_gpsPtr);
