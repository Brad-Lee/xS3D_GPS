...
public:
    ...
    //added part
    void sendSetGPSTarget();
    void sendSetAutoflight();

    // added part
    ros::ServiceClient SetGPSTarget_srv;
    ardrone_autonomy::SetGPSTarget SetGPSTarget_srv_srvs;
    ros::ServiceClient SetAutoflight_srv;
    ardrone_autonomy::RecordEnable SetAutoflight_srv_srvs;
