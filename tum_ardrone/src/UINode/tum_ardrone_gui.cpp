...
//added part (not using now)
void tum_ardrone_gui::SetGPSTargetClicked()
{    
    if(ui.radioButtonWP1->isChecked()){
        rosThread->SetGPSTarget_srv_srvs.request.target.position.latitude = 36.367140;
        rosThread->SetGPSTarget_srv_srvs.request.target.position.longitude = 127.363324;
        rosThread->SetGPSTarget_srv_srvs.request.target.position.altitude = 1.5;
    }else if(ui.radioButtonWP2->isChecked()){
        rosThread->SetGPSTarget_srv_srvs.request.target.position.latitude = 36.366905;
        rosThread->SetGPSTarget_srv_srvs.request.target.position.longitude = 127.363284;
        rosThread->SetGPSTarget_srv_srvs.request.target.position.altitude = 1.5;
    }else if(ui.radioButtonWP3->isChecked()){
        rosThread->SetGPSTarget_srv_srvs.request.target.position.latitude = 36.366931;
        rosThread->SetGPSTarget_srv_srvs.request.target.position.longitude = 127.363633;
        rosThread->SetGPSTarget_srv_srvs.request.target.position.altitude = 1.5;
    }
...
//added part
void tum_ardrone_gui::SetAutoflightClicked()
{
